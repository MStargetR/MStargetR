    ...
    bslib::layout_sidebar(
      sidebar = bslib::sidebar(
        ...
        shiny::conditionalPanel(
          ...
          shiny::textInput("qc_batch_column", "Batch column (optional)",
                           value = "", placeholder = "sample_plate_id"),
          htmltools::tags$p(class = "help-text",
            "Column in the imputed concentration data that defines the ",
            "ComBat batches. Leave blank to use ",
            htmltools::tags$code("sample_plate_id"),
            " (the qcCheckR default). Set this to drive the correction off ",
            "an arbitrary column (e.g. ", htmltools::tags$code("plate"),
            ", ", htmltools::tags$code("run_batch"), "); its values become ",
            "the valid choices for ", htmltools::tags$strong("Reference batch"),
            " below."
          ),
          shiny::textInput("qc_combat_ref_batch", "Reference batch (optional)", value = ""),
          htmltools::tags$p(class = "help-text",
            "Must match a value in the batch column above (case-sensitive). ",
